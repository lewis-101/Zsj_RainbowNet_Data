#G:\Image Decomposition\RainbowNet\data_prepare\picture\Places365_test_00000003.jpg
import cv2 as cv
import numpy as np
import os
...
def create_ranbinbow_stripes(srcImg):
    ...
    # plt.imsave('G:/Image Decomposition/RainbowNet_Data/data_pre/data_prepare/stripes/final_stripes.jpg', img)
...
if __name__ == "__main__":
    ...
    for files in img_list:
        ...
        # 读取条纹
        # final_stripes = plt.imread('G:/Image Decomposition/RainbowNet_Data/data_pre/data_prepare/stripes/final_stripes.jpg')
